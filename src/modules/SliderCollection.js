...
class Slider {
    ...
    constructor(rootElement) {
        ...
        this.nextButtonElement = this.navigationElement.querySelector(this.selectors.nextButtonElement);
        this.paginationElement = this.navigationElement.querySelector(this.selectors.paginationElement);
        this.scrollbarElement = this.rootElement.querySelector(this.selectors.scrollbarElement);
        this.init()
    }
